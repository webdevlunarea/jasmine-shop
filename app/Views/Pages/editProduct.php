                    ...
                    <table class="table-input w-100">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="baris"><input type="text" class="form-control"
                                            value="<?= $produk['nama']; ?>" name="nama" required></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Harga</td>
                            ...
                            <tr>
                                <td>Dimensi</td>
                                <td>
                                    <div class="baris"><input value="<?= $produk['dimensi']; ?>" type="text"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="baris"><input type="number" class="form-control"
                                            value="<?= $produk['stok']; ?>" name="stok" required></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Kategori</td>
                                <td>
                                    <div class="baris"><input type="text" class="form-control"
                                            value="<?= $produk['kategori']; ?>" name="kategori" required></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Sub Kategori</td>
                                <td>
                                    <div class="baris"><input type="text" class="form-control"
                                            value="<?= $produk['subkategori']; ?>" name="subkategori" required></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Varian</td>
                                <td>
                                    <div class="baris"><input type="text" class="form-control" value="<?= $varian; ?>"
                                            name="varian" required></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Jumlah Varian</td>
                                <td>
                                    <div class="baris"><input type="text" class="form-control"
                                            value="<?= $produk['jml_varian']; ?>" name="jml_varian" required></div>
                                </td>
                            </tr>
                            <tr>
                                <td>Deskripsi</td>
