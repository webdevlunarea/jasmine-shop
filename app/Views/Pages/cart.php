...
<div class="konten">
    <div class="container baris-ke-kolom">
                ...
                <div>
                    ...
                    <div class="d-flex gap-3 justify-content-end">
                        ...
                        <div class="input-group jumlah">
                            ...
                            <input disabled type="number" class="form-control text-center"
                                value="<?= $jumlah[$index]; ?>">
                            <a class="input-group-text"
                                href="/addcart/<?= $p['id']; ?>/<?= $keranjang[$index]['varian'] ?>/<?= $keranjang[$index]['index_gambar'] ?>">+</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cart-total">
            ...
            <a class="btn btn-danger mt-2 <?= !empty($keranjang) ? "" : "disabled"; ?>" href="/checkout">Proses
                Checkout</a>
        </div>
    </div>
</div>
