                ...
                <div id="flush-collapse3" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <ul>
                            ...
                            <li>
                                <p class="mb-0">Periksa rincian pesanan Anda, mulai dari varian, jumlah dan harga total</p>
                            </li>
                            <li>
                                <p class="mb-0">Klik “proses check out” pada bagian kanan atas</p>
                            </li>
                            <li>
                                <p class="mb-0">Teliti Kembali data atau informasi penerima sesuai dengan Alamat yang dituju</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p class="mb-0">Pilih metode pembayaran terbaik Anda serta segera lakukan pembayaran sesuai dengan jumlah tagihan sebelum kurun waktu yang tertera.</p>
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <p class="mb-0">Periksa rincian pesanan Anda dari nama produk, pilihan warna, dan jumlah</p>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <p class="mb-0">Menunggu pembayaran, artinya Anda belum melakukan pembayaran sesuai dengan nominal tagihan pada produk yang akan anda beli</p>
                            </li>
                            <li>
                                <p class="mb-0">Proses, artinya sistem telah mendeteksi pembayaran tagihan Anda sudah sesuai dan resi akan Anda terima untuk kemudian status produk pesanan berubah menjadi dikirim</p>
                            </li>
                            <li>
                                <p class="mb-0">Dikirim, artinya produk Anda sedang dalam proses pengiriman ke alamat tujuan</p>
                            </li>
                            <li>
