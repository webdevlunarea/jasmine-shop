    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="/all/<?= $produk['subkategori']; ?>"><?= str_replace('-', ' ', ucfirst($produk['subkategori'])) ?></a>
                </li>
        ...
        <div class="baris-ke-kolom">
            <div class="img-produk limapuluh-ke-seratus">
                <figure onmousemove="zoom(event)" onmouseleave="mouseoff(event)" class="img-produk-prev"
                    style="background-image: url('data:image/jpeg;base64,<?= base64_encode($gambar['gambar1']); ?>')">
                </figure>
                <img src="data:image/jpeg;base64,<?= base64_encode($gambar['gambar1']); ?>" alt=""
                    class="img-produk-prev hide-ke-show-block">
                <div>
            ...
            <div class="limapuluh-ke-seratus">
                ...
                <a class="btn btn-primary1" href="/addcart/<?= $produk['id']; ?>" id="btn-beli-product"
                    <?= (int)$produk['stok'] <= 0 ? "disabled" : ""; ?>>Beli Sekarang</a>
