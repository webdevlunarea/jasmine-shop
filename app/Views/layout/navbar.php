<nav class="navbar-hp hide-ke-show-block py-2">
    <div class="container d-flex">
        <!-- <a class="navbar-brand" href="/" style="font-weight: bold;">
            <img src="../img/Logo Jasmine.png" height="30em">
        </a> -->
        <form class="d-flex flex-grow-1" role="search" id="search-box">
            <div class="input-group">
                <input required id="search-input" type="text" class="form-control" placeholder="Search"
    ...
    <div class="container pt-1">
        <div class="d-flex mt-1" style="gap: 1px; background-color: rgba(255, 255, 255, 0.5)">
            <a style="font-size: smaller; background-color: var(--hijau)"
                class="nav-link flex-grow-1 text-center <?= $title == 'Beranda' ? "active " : ""; ?>"
                href="/">Beranda</a>
            <a style="font-size: smaller; background-color: var(--hijau) "
                class="nav-link flex-grow-1 text-center <?= $title == 'Tentang' ? "active " : ""; ?>"
                href="/about">Tentang</a>
            <a style="font-size: smaller; background-color: var(--hijau)"
                class="nav-link flex-grow-1 text-center <?= $title == 'Semua Produk' ? "active " : ""; ?>"
                href="/all">Produk</a>
        </div>
    </div>
</nav>
