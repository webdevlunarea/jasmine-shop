            ...
            <div class="d-flex gap-2" style="flex: 2;">
                ...
                <div style="flex: 1;">
                    ...
                    <ul class="footer__left-menu">
                        ...
                        <li class="d-flex align-items-center"><svg class="socialSvg" width="512px" height="512px" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg><a href="https://www.tiktok.com/@lunareafurnitureofficial">Tiktok</a></li>
                        <li class="d-flex align-items-center"><svg class="socialSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            ...
                            </svg><a href="https://www.threads.net/@lunareafurniture.official">Threads</a></li>
                        <li class="d-flex align-items-center"><svg class="socialSvg" viewBox="0 0 512 512" height="1.7em" xmlns="http://www.w3.org/2000/svg">
                                <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>
                            </svg><a href="https://x.com/official14312">Twitter</a></li>
                        <li class="d-flex align-items-center"><svg class="socialSvg" xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" height="24">
                                <path d="M16.75,9H13.5V7a1,1,0,0,1,1-1h2V3H14a4,4,0,0,0-4,4V9H8v3h2v9h3.5V12H16Z"></path>
                            </svg><a href="https://www.facebook.com/profile.php?id=61560396845112&locale=id_ID">Facebook</a></li>
                        <li class="d-flex align-items-center"><svg class="socialSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                <path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path>
                            </svg><a href="https://www.youtube.com/@LunareaFurnitureOfficial">Youtube</a></li>
                    </ul>
                </div>
            </div>
            <div style="flex: 2;">
