        ...
        <div class="row pt-5">
            ...
            <div class="col-8 col-md-3 mb-3">
                ...
                <ul class="footer__left-menu">
                    ...
                    <li><a
                            href="<?= session()->get('isLogin') ? "/account" : "/login" ?>"><?= session()->get('isLogin') ? "Akun" : "Masuk" ?></a>
                    </li>
            ...
            <div class="col-12 col-md-3">
                <div class="footer__service-customer">
                    ...
                    <div class="mt-2">
                        ...
                        <div>
                            <a href="#" title="Shopee" target="blank" style=""><img src="/img/logo/shopee.png"
                                    class="marketplace">
                            </a>
                            <a href="#" title="Tokopedia" target="blank"><img src="/img/logo/tokopedia.png"
                                    class="marketplace">
                            </a>
                        </div>
                    </div>
