...
<body>
    ...
    <?php if (!str_contains($title, "Artikel")) { ?>
        <div class="container-melayang d-flex flex-column gap-2">
            ...
            <a class="btn-circle hijau" id="btn-wa" href="https://api.whatsapp.com/send?phone=628112938160&text=Hallo%20CS%20*Jasmine*%2C%20saya%20ingin%20membeli%20furniture.....">
